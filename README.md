# DatabaseDemo
Demonstrates how to open an image from a database and save it back.  

There is a sample MS Access database included.  The source code for this demo shows 
this functionality with an OLE database and can be easily modified to work with 
other data sources such as SQL.

This is the VB.NET version. We also offer a [C# version](https://github.com/AtalaSupport/DemoGallery_Desktop_DatabaseDemo_CS_x64).  
...
## Downloading source
The sources can be downloaded for [c#](https://github.com/AtalaSupport/DemoGallery_Desktop_CustomCommandDemo_CS_x64/archive/refs/heads/main.zip) and [VB.NET](https://github.com/AtalaSupport/DemoGallery_Desktop_CustomCommandDemo_VB_x64/archive/refs/heads/main.zip)
...
```bash
git clone https://github.com/AtalaSupport/DemoGallery_DatabaseDemo_VB_x64.git DatabaseDemo --recursive
cd DatabaseDemo
git submodule init
